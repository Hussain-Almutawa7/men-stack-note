...
- Create a folder called `css` inside of `public`
- Create a file called `style.css` inside of `css`
...
- Link to images like `<img src="/images/family.jpg" alt="A happy family">`
